class Game {
  ...
  displayRank() {
    ...
    imageMode(CENTER);
    image(bronzeImg, displayWidth / -4, -100 + displayHeight / 9, 200, 250);
    image(silverImg, displayWidth / 4, -100 + displayHeight / 9, 200, 250);
    image(goldImg, 0, -100, 200, 250);
    ...
    for (var plr in allPlayers) {
      ...
      if (allPlayers[plr].place === 1) {
        ...
        text("3rd :" + allPlayers[plr].name, displayWidth / -4, displayHeight / 9 + 70);
      }
      else {
